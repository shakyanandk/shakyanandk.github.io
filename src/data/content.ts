...
const about = {
  ...
  resume: 'https://drive.google.com/file/d/1-xpEYbi_2ujnc3S6VoRuKVSUbecYnxE-/view?usp=drive_link',
  social: {
...
const skillCategories = [
  {
    ...
    skills: ['React', 'Redux', 'JavaScript', 'TypeScript', 'HTML', 'CSS', 'Angular', 'Vue'],
  ...
  {
    title: 'Testing & Tools',
    skills: ['Jest', 'Enzyme', 'Karma', 'Git', 'CI/CD', 'Agile Methodology'],
...
const experience = [
  {
    ...
    description: 'Developing scalable front-end applications for a dynamic e-commerce platform, focusing on performance, accessibility, and seamless integration with ASP.NET backend.',
    achievements: [
  ...
  },
  {
    ...
    description: 'Delivered high-impact full-stack and UI development solutions for cross-border payments, banking, and manufacturing clients in Agile environments.',
    achievements: [
      ...
      'Built Angular JS dashboards for SCM and order tracking, increasing operational visibility across 10+ business units',
      ...
      'Worked across diverse stacks including React JS, TypeScript, Next.js, GraphQL, Java Spring Boot, and ASP.NET'
    ]
  },
  {
    ...
    description: 'Developed FLEXCUBE Core Banking product customizations and provided end-to-end implementation, migration, and production support for global banking clients.',
    achievements: [
...
const sections = {
  ...
  skills: {
    ...
    experience: '{highlight:8+ years} of professional experience delivering scalable solutions'
  },
  experience: {
